...
header:
  teaser: /assets/images/hexagon-canvas-simulation.png
  og_image: /assets/images/hexagon-canvas-simulation.png
---
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  let ballX = centerX;
  let ballY = centerY;
  let ballColor = getCanvasThemeColors().ball;
  ...
  window.addEventListener('themechange', function(event) {
    ballColor = getCanvasThemeColors().ball;
  });
